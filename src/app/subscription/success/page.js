    ...
    return (
      <div style={{ textAlign: 'center', padding: '40px 0' }}>
        <div style={{
          ...
          background: 'rgba(0, 112, 243, 0.08)', marginBottom: '28px'
        }}>
          <div style={{
            width: '36px', height: '36px', border: '3px solid rgba(0,112,243,0.2)',
            borderLeftColor: '#0070f3', borderRadius: '50%', animation: 'spin 1s linear infinite'
          }}></div>
        </div>
    ...
    return (
      <div style={{ textAlign: 'center', padding: '40px 0' }}>
        ...
        <button
          ...
          style={{ borderRadius: '14px', padding: '14px 28px', display: 'inline-flex', alignItems: 'center', gap: '8px' }}
        >
  ...
  return (
    <div style={{ textAlign: 'center', padding: '40px 0' }} className="fade-in">
      ...
      <div style={{
        ...
        borderRadius: '50px', padding: '6px 14px', color: '#00e676',
        fontSize: '0.8rem', fontWeight: '600', marginBottom: '20px'
      }}>
        <Sparkles size={12} /> PREMIUM ACTIVATED
      </div>

      <h2 style={{ fontSize: '2.2rem', color: 'white', marginBottom: '12px', letterSpacing: '-1px' }}>
        Welcome to Pro!
      </h2>
      ...
      <div style={{
        ...
        borderRadius: '16px', padding: '24px', maxWidth: '380px', margin: '0 auto 30px',
        textAlign: 'left'
      }}>
  ...
  return (
    <div style={{ position: 'relative', overflow: 'hidden', minHeight: '90vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 24px' }}>
      ...
      <div className="glow-card" style={{
        ...
        boxShadow: '0 30px 60px rgba(0,0,0,0.8), 0 0 30px rgba(0, 230, 118, 0.05)'
      }}>
        <Suspense fallback={
          <div style={{ textAlign: 'center', padding: '40px 0' }}>
            <div style={{
